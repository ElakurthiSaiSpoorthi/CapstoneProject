...
public class FundTransferStepDefinition {
	...
	/*
	 * @Then("User should see an error message for insufficient funds") public void
	 * user_should_see_an_error_message_for_insufficient_funds() {
	 * Assert.assertTrue(fundTransferPage.isInsufficientFundsMessageDisplayed(),
	 * "Insufficient funds message not displayed"); }
	 * 
	 * @Then("Transfer should not be processed") public void
	 * transfer_should_not_be_processed() {
	 * Assert.assertTrue(fundTransferPage.isInvalidAmountMessageDisplayed(),
	 * "Invalid amount message not displayed"); }
	 * 
	 * @When("User transfer {int} from {string} to {string}") public void
	 * user_transfer_from_to(Integer amount, String from, String to) {
	 * fundTransferPage.performFundTransfer(from,to,amount); }
	 * 
	 * @Then("User should see an error message for invalid amount") public void
	 * user_should_see_an_error_message_for_invalid_amount() {
	 * Assert.assertTrue(fundTransferPage.isInvalidAmountMessageDisplayed(),
	 * "Invalid amount message not displayed"); }
	 */
